...
import { SIPSIILBAN_COPY, type SipsiilbanLang } from "@/lib/sipsiilban-copy";
...
function LangToggle({ lang, onChange }: { lang: SipsiilbanLang; onChange: (lang: SipsiilbanLang) => void }) {
  return (
...
export function SipsiilbanPage() {
  const [lang, setLang] = useState<SipsiilbanLang>("ko");
  const t = SIPSIILBAN_COPY[lang];
    ...
    <>
        <header className="mobile-header">
          ...
          <nav className="mobile-header__nav">
            ...
            <a href="#flow" className="mobile-header__link reveal-load" data-reveal-delay="220" data-section="flow">{t.navFlow}</a>
            <a href="#product" className="mobile-header__link reveal-load" data-reveal-delay="260" data-section="product">{t.navProduct}</a>
          </nav>
        ...
        <aside className="sidebar cs-sidebar reveal-load">
          <div className="sidebar-top">
            ...
            <nav className="sidebar-nav">
              ...
              <a href="#flow" className="nav-link reveal-load" data-reveal-delay="220" data-section="flow">{t.navFlow}</a>
              <a href="#product" className="nav-link reveal-load" data-reveal-delay="260" data-section="product">{t.navProduct}</a>
            </nav>
          </div>
        ...
        <main className="content">
          ...
          <section id="overview" className="section cs-hero">
            <div className="centered">
              ...
              <div className="cs-hero__contributions">
                ...
                <span className="cs-hero__tag reveal-load" data-reveal-delay="360" data-tip={t.tagAppTip}>{t.tagApp}</span>
                <span className="cs-hero__tag reveal-load" data-reveal-delay="420" data-tip={t.tagQrTip}>{t.tagQr}</span>
                <span className="cs-hero__tag reveal-load" data-reveal-delay="480" data-tip={t.tagSilverTip}>{t.tagSilver}</span>
              </div>
            </div>
          </section>
          ...
          <section className="cs-image cs-image--wide">
            <div className="centered">
              <div className="cs-image__wrap reveal-load" data-reveal-delay="300">
                <img src="/images/sipsiilban/cover.jpg" alt="십시일반" loading="lazy" />
              </div>
            </div>
          </section>
          ...
          <section id="flow" className="cs-section">
            <div className="centered">
              <h2 className="cs-heading shiny-hover">{t.flow}</h2>
              <div className="cs-body">
                <p>{t.flow1}</p>
                <p>{t.flow2}</p>
              </div>
              <div className="cs-focus-list">
                <div className="cs-focus-item">
                  <h3 className="cs-focus-item__title">{t.fl1t}</h3>
                  <p className="cs-focus-item__desc">{t.fl1d}</p>
                </div>
                <div className="cs-focus-item">
                  <h3 className="cs-focus-item__title">{t.fl2t}</h3>
                  <p className="cs-focus-item__desc">{t.fl2d}</p>
                </div>
                <div className="cs-focus-item">
                  <h3 className="cs-focus-item__title">{t.fl3t}</h3>
                  <p className="cs-focus-item__desc">{t.fl3d}</p>
                </div>
                <div className="cs-focus-item">
                  <h3 className="cs-focus-item__title">{t.fl4t}</h3>
                  <p className="cs-focus-item__desc">{t.fl4d}</p>
                </div>
              </div>
            </div>
          </section>
