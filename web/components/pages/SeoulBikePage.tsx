...
import { SEOUL_BIKE_COPY, type SeoulBikeLang } from "@/lib/seoul-bike-copy";
...
function LangToggle({ lang, onChange }: { lang: SeoulBikeLang; onChange: (lang: SeoulBikeLang) => void }) {
  return (
...
export function SeoulBikePage() {
  const [lang, setLang] = useState<SeoulBikeLang>("ko");
  const t = SEOUL_BIKE_COPY[lang];
  ...
  return (
    <>
        ...
        <main className="content">
          ...
          <section id="overview" className="section cs-hero">
            <div className="centered">
              ...
              <div className="cs-hero__contributions">
                ...
                <span className="cs-hero__tag reveal-load" data-reveal-delay="420" data-tip={t.tagMapTip}>{t.tagMap}</span>
          ...
          <section className="cs-image cs-image--wide">
            <div className="centered">
              <div className="cs-image__wrap reveal-load" data-reveal-delay="300">
                <img src="/images/work-seoul-access.png" alt="Seoul Bike Accident Insights" loading="lazy" />
              </div>
            </div>
          </section>
          ...
          <section className="cs-image cs-image--wide">
            <div className="centered">
              <div className="cs-diagram cs-tree" id="seoulPipelineTree"></div>
            </div>
          </section>
          ...
          <section className="cs-image cs-image--wide">
            <div className="centered">
              <div className="cs-diagram cs-tree" id="seoulSystemTree"></div>
            </div>
          </section>
